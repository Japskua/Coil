/**
 * Created by parkkila on 30.10.2015.
 */
"use strict";

var Achievements = {
    ownedAchievements : [],
    allAchievements : ["circle10InARow", "learnToCircle", "failCircling"],
    /**
     ...
     */
    retrieveAchievementsFromGamecloud : function() {
        Events.checkOwnedAchievementFromGamecloud(Gamecloud.getUserId());
        // Once done, callback
    },
    /**
